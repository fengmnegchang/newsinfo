...
public class SettingsActivity extends CommonFragmentActivity {
	...
	protected void initCookies(boolean isfirst) {
		if (isfirst) {
			...
			value2.setText("1908767344-1456467599-http%253A%252F%252Fwww.yidianzixun.com%252F%7C1477536295");

			key3.setText("captcha");
			value3.setText("s%3Af075e21f410e9e2739aebd21d4817b45.QQ%2Bq05pDslaDGkdJFV0uL3ZZQBXtbqf36wYrGsvuQx8");

			key4.setText("Hm_lvt_15fafbae2b9b11d280c79eff3b840e45");
			value4.setText("1477272275,1477358473,1477445179,1477531397");

			key5.setText("Hm_lpvt_15fafbae2b9b11d280c79eff3b840e45");
			value5.setText("1477538812");
